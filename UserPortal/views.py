...
class EditProfile(UpdateView):
    ...
    fields = ['full_name', 'email', 'bio', 'college', 'mailing_list', 'tape_colour_1', 'tape_colour_2', 'tape_colour_3', 'tape_colour_notes']
...
class SuperEditProfile(UpdateView):
    ...
    template_name = 'registration/EditProfile.html'
    fields = ['username', 'rank', 'user_key', 'full_name', 'email', 'bio', 'college', 'mailing_list', 'tape_colour_1', 'tape_colour_2', 'tape_colour_3', 'tape_colour_notes']
    template_name_suffix = '_update_form'
    slug_field = 'user_key'
