...
urlpatterns = [
	...
	# About
    path('About/', RedirectView.as_view(url='/About/Meets/'), name='AboutRedirect'),
	...
	# Contact
    path('Contact/', RedirectView.as_view(url='/Contact/Committee/'), name='ContactRedirect'),
	...
	# Meets
    path('Meets/', RedirectView.as_view(url='/Meets/Calendar/'), name='MeetsRedirect'),
	...
	# Get Involved
    path('GetInvolved/', RedirectView.as_view(url='/GetInvolved/HowToJoin/'), name='GetInvolvedRedirect'),
	path('GetInvolved/HowToJoin/', views.GetInvolvedHowToJoin.as_view(), name='GetInvolvedHowToJoin'),

    # Library
    path('Library/', RedirectView.as_view(url='/About/Library/'), name='LibraryRedirect'),
	...
	# Misc
    path('Misc/', RedirectView.as_view(url='/'), name='MiscRedirect'),
    ...
    # Ardheche
    path('Ardeche/', RedirectView.as_view(url='/About/TripsAbroad/'), name='ArdecheRedirect'),
